...
- [x] 1. Extend `TaskEntry` with `dependencies` field
  ...
  - [x] 1.1 Write tests for dependency parsing
...
- [x] 4. Implement `select_runnable()` function
  ...
  - [x] 4.1 Write tests for scheduler DAG mode
  ...
  - [x] 4.2 Write tests for scheduler Sequential mode
...
- [x] 5. Checkpoint - Scheduler module compiles and all tests pass
  - Run `make test` and `make lint`
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Add `scheduler_mode` to `FeatureExecutionConfig`
  ...
  - [x] 6.1 Write tests for config backward compatibility
...
- [x] 7. Modify `FeatureExecutor` to use scheduler
  ...
  - [x] 7.1 Write tests for executor integration with scheduler
...
- [x] 8. Checkpoint - Executor changes compile and all tests pass
  - Run `make test` and `make lint`
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Update `poll_feature_executor` in `app.rs`
  ...
  - [x] 9.1 Write integration tests for phase transitions
