...
- [ ] 2. Create `ExpertPanelDisplay` widget with core state management
  ...
  - [ ] 2.1 Write unit tests for `ExpertPanelDisplay` state management
...
- [ ] 3. Write ANSI parsing tests and integration
...
- [ ] 4. Checkpoint — Widget and ANSI parsing
...
- [ ] 5. Extend `TmuxSender` trait with `capture_pane_with_escapes`
  ...
  - [ ] 5.1 Write test for `capture_pane_with_escapes` default fallback
...
- [ ] 6. Implement `keycode_to_tmux_key` conversion utility
  ...
  - [ ] 6.1 Write unit tests for `keycode_to_tmux_key`
...
- [ ] 7. Checkpoint — Trait extension and key conversion
  - Run `make test` to ensure all tests pass including new tmux and key conversion tests
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Extend `FocusArea` and `LayoutAreas` for `ExpertPanel`
...
- [ ] 9. Add `ExpertPanelDisplay` field and accessors to `TowerApp`
...
- [ ] 10. Update focus cycling to conditionally include `ExpertPanel`
  ...
  - [ ] 10.1 Write focus cycling tests
...
- [ ] 11. Update mouse click handling
...
- [ ] 12. Checkpoint — Focus, layout, mouse integration
  - Run `make test` to ensure all focus cycling, mouse click, and layout tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 13. Implement `handle_expert_panel_keys` method
...
- [ ] 14. Implement `poll_expert_panel` method
...
- [ ] 15. Integrate `Ctrl+J` toggle and `ExpertPanel` arm in `handle_events`
